...
csv_head = [
    ...
    'fb_new_bet_sum', 'ol_new_bet_sum', 'fb_bal', 'ol_bal', 'fb_max_bet', 'maxbet_fact', 'fb_max_bet_fact', 'fb_bet_delay', 'fb_is_top', 'fb_is_hot', 'fork_slice', 'cnt_act_acc', 'place', 'time_type', 'fork_time',
