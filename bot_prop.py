...
ADMINS = [381868674, 33847743, 819884131]
IP_SERVER = '193.176.79.17:8888'
...
MSG_CHANGE_ACC_NONE = 'Нет запущенных аккаунтов'
MSG_ACC_START_WAIT = 'Аккаунт запускается, пожалуйста ждите...'
...
BTN_GET_LOG_BET = emojize(':scroll:', use_aliases=True) + ' Скачать лог ставок'
BTN_GET_LOG_FORK = emojize(':fork_and_knife:', use_aliases=True) + ' Скачать лог вилок'
