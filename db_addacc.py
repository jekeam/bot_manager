...
if __name__ == '__main__':
    try:
        acc = Account.create(
            ...
            status='active',
            work_status='start',
            properties=r'{ "summ": 560, "random_summ_proc": 30, "fork_life_time": 3, "server_ip_test": "149.154.70.53", "server_ip": "62.109.10.57", "work_hour": 8, "round_fork": 5, "max_fork": 35, "max_fail": 3, "min_l": 0.999999 }',
    ...
    try:
        acc = Account.create(
            ...
            date_end=get_trunc_sysdate(30000),
            status='active',
            properties=r'{"summ": 400,"random_summ_proc": 30,"fork_life_time": 3,"server_ip_test": "149.154.70.53","server_ip": "62.109.10.57","work_hour": 8, "round_fork": 5,"max_fork": 35,"max_fail": 3,"min_l": 0.98}',
