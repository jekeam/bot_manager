...
if __name__ == '__main__':
    try:
        acc = Account.create(
            ...
            status='active',
            work_status='start',
            properties=r'{ "summ": 560, "random_summ_proc": 30, "fork_life_time": 3, "server_ip_test": "149.154.70.53", "server_ip": "62.109.10.57", "work_hour": 0, "round_fork": 5, "max_fork": 1, "max_fail": 5, "min_l": 0.995 }',
    ...
    try:
        acc = Account.create(
            ...
            date_end=get_trunc_sysdate(30000),
            status='active',
            properties=r'{"summ": 400,"random_summ_proc": 30,"fork_life_time": 3,"server_ip_test": "149.154.70.53","server_ip": "62.109.10.57","work_hour": 0, "round_fork": 5,"max_fork": 1,"max_fail": 6,"min_l": 0.99}',
            ...
            accounts=r'{"olimp": {"login": "6265127","password": "qvF3BwrNcRcJtB6","mirror": ""},"fonbet": {"login": 5699838,"password": "NTe2904H11","mirror": "fonbet.com"}}'
        )
    except Exception as e:
        print(e)
