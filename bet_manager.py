    ...
    def sale_bet(self, shared: dict):
        ...
        if self.bk_name == 'olimp':
            ...
            if self.cashout_allowed and self.sum_sell > 0:
                ...
                elif err_code == 403 and 'code:20' in err_msg:
                    prnt(self.msg.format(sys._getframe().f_code.co_name, 'Error code: ' + str(err_code) + ', Error msg: ' + err_msg))
            ...
            if err_code == 1:
                ...
                if 'Допустимая сумма ставки' in err_msg:
                    try:
                        ...
                        prnt(self.msg.format(sys._getframe().f_code.co_name, 'min_bet={}, max_bet={}' + str(self.min_bet, self.max_bet)))
                ...
                if 'Превышена cуммарная ставка для события' in err_msg:
                    try:
                        ...
                        prnt(self.msg.format(sys._getframe().f_code.co_name, 'max_bet=' + str(self.max_bet)))
                        replay_bet(str(err_code))
                    except AttributeError as e:
                        prnt(self.msg.format(sys._getframe().f_code.co_name, str(e) + ': ' + err_msg))
                        self.max_bet = 0
