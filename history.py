...
def export_hist(OLIMP_USER, FONBET_USER):
 ...
 \
                          ...
                          str(info['fonbet'].get('inversion_bet', '')) + ';' + \
 \
 ...
 \
                ...
                header = 'ID;time;event_type;pre_fb_kof;pre_o_kof;pre_fb_sum;pre_o_sum;' \
                         ...
                         'o_sum_sale;f_kof_type;o_kof_type;fb_vector;ol_vector;first_bet_in;inversion_bet;fb_time_bet;ol_time_bet;' \
    ...
    if os.path.isfile(str(ACC_ID) + '_to_cl.log'):
        try:
            os.rename(str(ACC_ID) + '_to_cl.log', cur_date_str + '_' + str(ACC_ID) + '_to_cl.log')
        except Exception as e:
            prnt(e)
    if os.path.isfile(file_name):
        try:
