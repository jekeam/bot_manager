...
prop_abr = {
    ...
    "SERVER_OLIMP": {"abr": "Зеркало Олимп", "type": "mirror:olimp", "max": "", "min": "", "default": "olimp.kz", "error": ""},
    ...
    "TIMEOUT_FORK": {"abr": "Ждать после ставки", "type": "int", "max": "5400", "min": "0", "default": 120, "access_list": [], "error": ""},
