...
prop_abr = {
    ...
    "SUMM_MIN": {"abr": "Ставка ОТ", "type": "int", "max": "10000", "min": "100", "access_list": [], "default": 100, "error": ""},
    ...
    "TOTAL_FIRST": {"abr": "Первая ставка на Тот.", "type": "str", "max": "", "min": "", "access_list": ["ТМ", "ТБ", "auto"], "default": "ТМ", "error": ""},
